...
import { SquareM, BookOpenText, Layers } from "lucide-react";

export default function Tmbar() {
  const { currentView, changeView } = useResources();

  return (
    <Container className="sticky top-12 z-10 col-span-3 flex justify-between items-center px-4 py-1.5 border-b border-border bg-cat-memory">
      <SearchForm
